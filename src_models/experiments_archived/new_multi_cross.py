...
def train(args):
    ...
    if start_sub and end_sub:
        ...
        # evaluation loader
        evaldataset = MyDataset(datasource = [all_data[start_sub:end_sub], all_acc[start_sub:end_sub],
        ...
        traindataset = MyDataset(datasource = [all_data[:start_sub], all_acc[:start_sub], all_gyro[:start_sub], all_mag[:start_sub]],
        ...
        # evaluation loader
        evaldataset = MyDataset(datasource = [all_data[start_sub:], all_acc[start_sub:],all_gyro[start_sub:],all_mag[start_sub:]],
                                    labels = all_labels[start_sub:],
                                    window_size=1.5, 
                                    step_size=0.5, 
                                    transform=None,
        ...
        traindataset = MyDataset(datasource = [all_data[end_sub:],all_acc[end_sub:],all_gyro[end_sub:],all_mag[end_sub:]],
        ...
        # evaluation loader
        evaldataset= MyDataset(datasource = [all_data[:end_sub],all_acc[:end_sub],all_gyro[:end_sub],all_mag[:end_sub]], 
                                labels = all_labels[:end_sub],
                                window_size=1.5, 
                                step_size=0.5, 
                                transform=None,
